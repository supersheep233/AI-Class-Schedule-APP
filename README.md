...
- 确认没有把真实 API Key、Token、内网地址提交到仓库
- 确认 `output/`、`__tmp/`、`.dart_tool/` 等生成目录没有被跟踪
- 确认 `README.md`、`.gitignore`、`pubspec.lock` 已按预期提交
...
如果你打算开源，建议补充一个 `LICENSE` 文件，例如 MIT 或 Apache-2.0。
